...
public class MainActivity extends Activity {
    ...
    private void consume(ServiceInfo s,String type){
        ...
        try{for(String k:s.getPropertyNames()){byte[] raw=s.getPropertyBytes(k);applyField(d,k,raw==null?"":new String(raw,StandardCharsets.UTF_8).trim());}}catch(Throwable ignored){}
